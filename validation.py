...
def draw_roc(y_test, y_probs, index):
    names = ['E-MTAB-10938 (Pediatric - Internal Validation)','GSE144406 (Pediatric - External Validation)','E-MTAB-5882 (Adult - External Validation)','E-MTAB-1548 (Adult - External Validation)']
    ...
    plt.plot(fp_rate, tp_rate, label=names[index]+" [AUROC=" +str(round(auc,3)) + 
                     " ("+ str(round(confidence_lower,3))+" - "+str(round(confidence_upper,3))+")]")
